    ...
    <Box sx={styles.formWrapper}>
      ...
      <Box as="form" sx={styles.form} onSubmit={handleSubmit}>
        ...
        <Box sx={styles.buttonGroup}>
          <Button variant="primary" sx={styles.submit} onClick="window.location='https://rzp.io/i/tDjrLN3'">
            Donate Now
          </Button>
          <Text as="span">or</Text>
          <Button variant="muted" sx={styles.googlePay}>
            <Image width="41" height="40" src={googlePay} alt="googlePay" onClick="window.location='https://rzp.io/i/tDjrLN3'" />
