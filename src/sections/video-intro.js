...
const list = [
  ...
  'Letter of Recommendation to achievers and sincere interns',
  'Chance to get featured on our website + shoutout on social media handles',
  ' Stipend - 20% of the total funds raised',
  ' One Certificate '
];
        ...
        <Box sx={styles.grid}>
          ...
          <Box sx={styles.content}>
            <Heading sx={styles.title}>
              Future Care Foundation is a registered NGO under Societies Registration {' '}
              <span sx={{ background: `url(${paint1})` }}>Act 21, 1860, </span> Government of India. It is also registered with{' '}
              <span sx={{ background: `url(${paint2})` }}>12A and 80G.</span> It is working in the field of Education and Women Empowerment.
              .
            </Heading>
            <Text as="p" sx={styles.summary}>
              Want to work for an NGO?
              Do you find pleasure in working for the people and giving it back to the society? Here’s your chance to work with our NGO. We are accepting internship applications now for the position of "Fundraiser Intern".
              .
            </Text>
